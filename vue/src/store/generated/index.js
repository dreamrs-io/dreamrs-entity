...
import DreamrsEntityDreamrsEntityEntity from './dreamrs/entity/dreamrs.entity.entity';
export default {
    ...
    DreamrsEntityDreamrsEntityEntity: load(DreamrsEntityDreamrsEntityEntity, 'dreamrs.entity.entity'),
};
